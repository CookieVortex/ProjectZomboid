...
public class GameServer {
    ...
    static void receiveSendInventory(ByteBuffer var0, UdpConnection var1, short var2) {
        var0.mark();
        sendInventoryHandler(var0, var1, var2);
        var0.reset();
        short var3 = var0.getShort();
    ...
    static void receivePlayerUpdate(ByteBuffer var0, UdpConnection var1, short var2) {
        updatePlayerInventory(var1, var0, var2);
    ...
    public static void updatePlayerInventory(UdpConnection playerConnection, ByteBuffer buffer, short var2) {
    ...
    public static void sendInventoryHandler(ByteBuffer buffer, UdpConnection connection, short var2) {
    ...
    public static void sendReanimatedZombieID(IsoPlayer var0, IsoZombie var1) {
        if (PlayerToAddressMap.containsKey(var0)) {
            sendObjectChange(var0, "reanimatedID", "ID", var1.OnlineID);
        }
