...
import static zombie.chat.ChatUtility.findPlayer;
...
public abstract class ChatBase {
    ...
    private final String[] badWords = {"cук", "сука", "сyка", ""};
    ...
    public ChatMessage createMessage(String var1) {
        PerkFactory.Perk perkAim = PerkFactory.Perks.FromString("Aiming");
        IsoPlayer player = findPlayer(this.getChatOwnerName());

        DebugLog.log(">><<Aiming level: " + player.getXp().toString());
        return this.createMessage(this.getChatOwnerName(), var1);
    }

    private ChatMessage createMessage(String var1, String var2) {

        IsoPlayer player = findPlayer(var1);
        DebugLog.log(">><<Aiming level: " + player.getXp().toString());
        ChatMessage var3 = new ChatMessage(this, var1);
    ...
    public void showMessage(String var1, String var2) {
        ...
        IsoPlayer player = findPlayer(var2);
        DebugLog.log(">><<Aiming level: " + player.getXp().toString());
    }
    ...
    public void sendMessageToChatMembers(ChatMessage var1) {
        IsoPlayer var2 = findPlayer(var1.getAuthor());
        if (var2 == null) {
            ...
            synchronized(this.memberLock) {
                ...
                while(true) {
                    ...
                    IsoPlayer var6 = findPlayer(var5);
    ...
    public void sendMessageToChatMembers(ServerChatMessage var1) {
        synchronized(this.memberLock) {
            ...
            while(true) {
                ...
                short var4 = (Short)var3.next();
                IsoPlayer var5 = findPlayer(var4);
                if (var5 != null) {
